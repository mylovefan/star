...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static String DATE_LONG_DATETIME = "yyyyMMddHHmmss";
	...
	public static SimpleDateFormat sdfDayTime = new SimpleDateFormat("dd HH:mm:ss");
	...
	public static final SimpleDateFormat LONG_DATE_FORMAT_NOS = new SimpleDateFormat("yyyy-MM-dd HHmm");
	public static final SimpleDateFormat LONG_STRDATE_FORMAT = new SimpleDateFormat(DATE_LONG_DATETIME);
	 ...
	 * @return
	 */
	public static String getTimeStampStrNos(Date date) {
		return LONG_DATE_FORMAT_NOS.format(date);
	}
	/**
	 *
	 * @param date
	 * @return
	 */
	public static Date getTimeStampStr(String date) {
		try {
	...
	public static String getFormatStrDate(Date date) {
		return LONG_STRDATE_FORMAT.format(date);
	}
	
	public static Date parseFormatDateStr(String date) {
		try {
			return LONG_STRDATE_FORMAT.parse(date);
		} catch (ParseException e) {
			e.printStackTrace();
		}
		return null;
	...
	public static String toSqlTimestampString(Timestamp dt, String sFmt) {
		...
		temp = dt.toString();
		if (sFmt.equals(DATE_FORMAT_DATETIME) || // "YYYY/MM/DD
				// HH24:MI:SS"
				sFmt.equals(DATE_FORMAT_DATEONLY)) { // YYYY/MM/DD
	...
	public static List<String> getLastDays(int countDay) {
		...
		for (int i = 0; i < countDay; i++) {
			listDate.add(getReqDate(getDate(-i)));
		}
		return listDate;
	}

	/**
	 * 根据固定时间获取几天内日期 return 2014-5-4、2014-5-3
	 */
	public static List<String> getLastDays(Date date, int countDay) {
		List<String> listDate = new ArrayList<String>();
		for (int i = 0; i < countDay; i++) {
			listDate.add(getReqDate(getDate(date, -i)));
		}
		return listDate;
	}
	...
	public static Date getPastDate(int past) {  
	   ...
	   SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");   
	   String temp_str=sdf.format(today); 
	   Date createDate = null;
	   try {
			createDate = sdf.parse(temp_str.toString());
		} catch (ParseException e) {
